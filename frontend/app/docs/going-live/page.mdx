...
2. **Webhook** — in lava.top, point the webhook at `https://billing.inite.ai/webhooks/lava`, choose
   *API key* auth and set any key; paste the same key into **Webhook key** here. (It is not your
   API key.)

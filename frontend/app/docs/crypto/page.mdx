...
Prices must be in **USD**: a stablecoin is worth a dollar, and there is no exchange rate to price
anything else. Crypto is not offered at checkout for a price in any other currency.
